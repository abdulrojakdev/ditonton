...
import 'package:tv_series/data/models/tv_series_detail_seasons_model.dart';
import 'package:tv_series/data/models/tv_series_model.dart';
import 'package:tv_series/data/models/tv_series_responses.dart';
...
abstract class TvSeriesRemoteDataSource {
  ...
  Future<TvSeriesDetailSeasonsModel> getSeasonsTvSeries(int tvId, int seasonNumber);
}
...
class TvSeriesRemoteDataSourceImpl implements TvSeriesRemoteDataSource {
  ...
  @override
  Future<TvSeriesDetailSeasonsModel> getSeasonsTvSeries(int tvId, int seasonNumber) async {
    final response = await client.get(Uri.parse('$BASE_URL/tv/$tvId/season/$seasonNumber?$API_KEY'));

    if (response.statusCode == 200) {
      return TvSeriesDetailSeasonsModel.fromJson(json.decode(response.body));
    } else {
      throw ServerException();
    }
  }
