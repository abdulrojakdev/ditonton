...
class TvSeriesRepositoryImpl implements TvSeriesRepository {
  ...
  @override
  Future<Either<Failure, DetailSeasons>> getSeasonsTvSeries(int tvId, int seasonNumber) async {
    try {
      final result = await remoteDataSource.getSeasonsTvSeries(tvId, seasonNumber);
      return Right(result.toEntity());
    } on ServerException {
      return Left(ServerFailure(''));
    } on SocketException {
