...
// in tv_series/test/persentation/bloc/tv_series_detail_bloc_test.dart.
...
/// A class which mocks [GetDetailSeasonsTvSeries].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetDetailSeasonsTvSeries extends _i1.Mock
    implements _i13.GetDetailSeasonsTvSeries {
  MockGetDetailSeasonsTvSeries() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i2.TvSeriesRepository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
          returnValue: _FakeTvSeriesRepository_0()) as _i2.TvSeriesRepository);
  @override
  _i5.Future<_i3.Either<_i6.Failure, _i14.DetailSeasons?>> execute(
          int? tvId, int? seasonNumber) =>
      (super.noSuchMethod(Invocation.method(#execute, [tvId, seasonNumber]),
              returnValue:
                  Future<_i3.Either<_i6.Failure, _i14.DetailSeasons?>>.value(
                      _FakeEither_1<_i6.Failure, _i14.DetailSeasons?>()))
          as _i5.Future<_i3.Either<_i6.Failure, _i14.DetailSeasons?>>);
  @override
  String toString() => super.toString();
}
